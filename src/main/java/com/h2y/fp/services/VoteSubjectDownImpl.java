 ...
 * @version
 */
@Service(value="voteSubjectDown")
public class VoteSubjectDownImpl implements IFileDownService {
	...
	public FileDownMode getFileInfo(HttpServletRequest request, String id) {
		...
		Map<String,Object> fileData = fileDataDao.getVoteSubject(Long.valueOf(id));
		if (null==fileData) {
			return null;
		}
